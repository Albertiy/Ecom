        ...
        <div class="col-md-8"
            ...
            <form id="myform" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input id="sname" class="form-control">${store.sname}</input>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input id="saddress" class="form-control">${store.saddress}</input>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input id="introduce" class="form-control">${store.introduce}</input>
...
<form name="form1" id="form1" method="POST" action="mystore" onsubmit="return checkAgreement();" style="text-align: center">
